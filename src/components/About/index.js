      ...
      <div className="row">
        ...
        <div className="col-6">
          ...
          >
            ...
            <br />
            <br />
            Drawing from my extensive experience in sales and customer success, I have honed invaluable soft skills, such as exceptional communication, collaboration, and problem-solving. Additionally, I possess a deep understanding of gamification strategy, which I leverage to enhance user engagement and motivation. I have successfully designed and led impactful onboarding programs for enterprise customers, equipping key stakeholders with proven strategies that drive user participation and create immersive experiences within their communities. By combining my gamification expertise with my ability to create captivating user interfaces and optimize community-driven functionalities, I can develop interactive platforms that maximize engagement and deliver exceptional user experiences.
            <br />
          </p>
          <br />
          <br />
